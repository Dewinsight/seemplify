...
export function PdfDocumentPreview({ blob, title, emptyMessage = "No PDF preview is available yet." }: PdfDocumentPreviewProps) {
  ...
  return (
    <div className="h-full overflow-auto bg-slate-100 px-4 py-6">
      <div className="mx-auto flex max-w-[920px] flex-col gap-5">
        {pages.map((page) => (
          <figure key={page.pageNumber} className="rounded-sm bg-white shadow-sm ring-1 ring-slate-200">
            <img
              src={page.dataUrl}
