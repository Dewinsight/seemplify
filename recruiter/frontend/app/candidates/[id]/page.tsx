        ...
        <div className="mt-2 flex h-4 w-full rounded-full">
          {sentiment.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className={`flex-1 ${item.score < 0.4 ? "bg-red-500" : item.score < 0.7 ? "bg-yellow-500" : "bg-green-500"
            ...
            <Card className="border-0 glass-card shadow-lg">
              ...
              <CardContent className="p-6 space-y-6">
                <div className="space-y-4">
                  <div className="p-4 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/20 dark:to-blue-900/20 hover:from-blue-100 hover:to-blue-200 dark:hover:from-blue-900/30 dark:hover:to-blue-800/30 transition-all duration-200 border border-blue-200 dark:border-blue-500/10">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-blue-100 dark:bg-blue-600 flex items-center justify-center">
                        <Mail className="h-5 w-5 text-blue-600 dark:text-white" />
                      </div>
                      <div>
                  ...
                  <div className="p-4 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/20 dark:to-gray-800/20 hover:from-gray-100 hover:to-gray-200 dark:hover:from-gray-800/30 dark:hover:to-gray-700/30 transition-all duration-200 border border-gray-200 dark:border-white/5">
                    <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <Badge variant="outline" className="bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-900/20 dark:text-blue-300 dark:border-blue-500/30">
                  ...
                  {(candidate.skills && ((typeof candidate.skills === 'string' && candidate.skills.trim()) || (Array.isArray(candidate.skills) && candidate.skills.length > 0))) && (
                    <div className="p-4 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/20 dark:to-gray-800/20 hover:from-gray-100 hover:to-gray-200 dark:hover:from-gray-800/30 dark:hover:to-gray-700/30 transition-all duration-200 border border-gray-200 dark:border-white/5">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium text-gray-600 dark:text-gray-300 mb-2">Skills</p>
                          <div className="flex flex-wrap gap-2">
                            {candidate.skills && typeof candidate.skills === 'string' ? (
                              candidate.skills.split(',').map((skill, index) => (
                                <Badge key={index} variant="outline" className="bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-900/20 dark:text-blue-300 dark:border-blue-500/30">
                                  {skill.trim()}
                                </Badge>
                              ))
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full max-w-full overflow-hidden" >
                  ...
                  <TabsContent value="overview" className="space-y-6 animate-in fade-in-50 duration-500">
                      ...
                      <Card className="border-0 shadow-sm hover:shadow-md transition-shadow duration-300">
                        ...
                        <CardContent className="space-y-6">
                          ...
                          {candidate.workExperience.experienceSummary && (
                            <div className="rounded-lg border border-blue-200 dark:border-blue-500/10 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 p-4">
                              <h3 className="font-semibold text-blue-700 dark:text-blue-300 mb-2">Career Summary</h3>
                    ...
                    <Card className="glass-card border-0 shadow-lg">
                      <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/40 dark:to-indigo-950/40 rounded-t-lg border-b border-blue-100 dark:border-white/5">
                      ...
                      <CardContent className="pt-6">
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{candidate.aiAnalysis?.summary || "No summary available"}</p>
                      </CardContent>
                    </Card>

                    <Card className="glass-card border-0 shadow-lg">
                      <CardHeader className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/40 dark:to-pink-950/40 rounded-t-lg border-b border-purple-100 dark:border-white/5">
                      ...
                      <CardContent className="pt-6">
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{candidate.experience || "No experience information available"}</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="glass-card border-0 shadow-lg">
                      ...
                      <CardContent className="pt-6">
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{candidate.education || "No education information available"}</p>
                      </CardContent>
                    </Card>
                      ...
                      <Card className="glass-card border-0 shadow-lg">
                        ...
                        <CardContent className="pt-6 space-y-4">
                          {candidate.educationHistory.map((edu: any, index: number) => (
                            <div key={index} className="border-l-4 border-emerald-500/50 pl-4 py-2 hover:bg-gray-50 dark:hover:bg-white/5 rounded-r-lg transition-colors">
                              ...
                              {edu.graduationYear && <p className="text-sm text-gray-500 dark:text-gray-400">Graduated: {edu.graduationYear}</p>}
                              {edu.gpa && <p className="text-sm text-gray-500 dark:text-gray-400">GPA: {edu.gpa}</p>}
                              {edu.honors && <p className="text-sm text-emerald-600 dark:text-emerald-400 font-medium">{edu.honors}</p>}
                    ...
                    {candidate.certifications && candidate.certifications.length > 0 && (
                      <Card className="glass-card border-0 shadow-lg">
                        <CardHeader className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/40 dark:to-orange-950/40 rounded-t-lg border-b border-amber-100 dark:border-white/5">
                        ...
                        <CardContent className="pt-6">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {candidate.certifications.map((cert: any, index: number) => (
                              <div key={index} className="border border-gray-200 dark:border-white/10 rounded-lg p-4 bg-amber-50 dark:bg-amber-950/10 hover:bg-amber-100 dark:hover:bg-amber-950/20 transition-colors">
                                <h4 className="font-semibold text-amber-900 dark:text-amber-100">{cert.name}</h4>
                                {cert.issuingOrganization && <p className="text-sm text-amber-800/80 dark:text-amber-200/80">{cert.issuingOrganization}</p>}
                                <div className="mt-2 space-y-1">
                                  {cert.issueDate && <p className="text-xs text-gray-500 dark:text-gray-400">Issued: {cert.issueDate}</p>}
                                  {cert.expiryDate && <p className="text-xs text-gray-500 dark:text-gray-400">Expires: {cert.expiryDate}</p>}
                                  {cert.credentialId && <p className="text-xs text-gray-500 dark:text-gray-400">ID: {cert.credentialId}</p>}
                                </div>
                                {cert.description && <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">{cert.description}</p>}
                                {cert.credentialUrl && (
                                  <a href={cert.credentialUrl} target="_blank" rel="noopener noreferrer"
                                    className="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 hover:underline mt-2 inline-block">
                                    Verify Credential →
                                  </a>
                                )}
                              </div>
                    ...
                    {candidate.languages && candidate.languages.length > 0 && (
                      <Card className="glass-card border-0 shadow-lg">
                        <CardHeader className="bg-gradient-to-r from-cyan-50 to-blue-50 dark:from-cyan-950/40 dark:to-blue-950/40 rounded-t-lg border-b border-cyan-100 dark:border-white/5">
                        ...
                        <CardContent className="pt-6">
                          <div className="flex flex-wrap gap-3">
                            {candidate.languages.map((lang: any, index: number) => (
                              <div key={index} className="px-4 py-2 bg-cyan-100 dark:bg-cyan-900/30 border border-cyan-200 dark:border-cyan-500/20 rounded-full">
                                <span className="font-medium text-cyan-900 dark:text-cyan-200">{lang.language}</span>
                                {lang.proficiency && <span className="text-cyan-700 dark:text-cyan-400 ml-2">• {lang.proficiency}</span>}
                                {lang.certifications && <span className="text-xs text-cyan-800 dark:text-cyan-500 block mt-1">{lang.certifications}</span>}
                              </div>
                            ))}
                          </div>
                        </CardContent>
                    ...
                    {candidate.awards && candidate.awards.length > 0 && (
                      <Card className="glass-card border-0 shadow-lg">
                        <CardHeader className="bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-950/40 dark:to-amber-950/40 rounded-t-lg border-b border-yellow-100 dark:border-white/5">
                        ...
                        <CardContent className="pt-6 space-y-3">
                          {candidate.awards.map((award: any, index: number) => (
                            <div key={index} className="flex items-start gap-3 p-3 bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-500/10 rounded-lg">
                              <Trophy className="h-5 w-5 text-yellow-600 dark:text-yellow-500 mt-1 flex-shrink-0" />
                              <div>
                                <h4 className="font-semibold text-yellow-900 dark:text-yellow-200">{award.title}</h4>
                                {award.issuer && <p className="text-sm text-yellow-800/70 dark:text-yellow-100/70">{award.issuer}</p>}
                                {award.date && <p className="text-xs text-gray-500 dark:text-gray-400">{award.date}</p>}
                                {award.description && <p className="text-sm text-gray-700 dark:text-gray-300 mt-1">{award.description}</p>}
                              </div>
                            </div>
                          ))}
                        </CardContent>
                    ...
                    {candidate.projects && candidate.projects.length > 0 && (
                      <Card className="glass-card border-0 shadow-lg">
                        <CardHeader className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-950/40 dark:to-purple-950/40 rounded-t-lg border-b border-indigo-100 dark:border-white/5">
                        ...
                        <CardContent className="pt-6 space-y-4">
                          {candidate.projects.map((project: any, index: number) => (
                            <div key={index} className="border border-indigo-200 dark:border-white/10 rounded-lg p-4 bg-indigo-50 dark:bg-white/5 hover:bg-indigo-100 dark:hover:bg-white/10 transition-colors">
                              <div className="flex justify-between items-start">
                                <h4 className="font-semibold text-indigo-900 dark:text-indigo-100">{project.title}</h4>
                                {project.url && (
                                  <a href={project.url} target="_blank" rel="noopener noreferrer"
                                    className="text-blue-600 dark:text-blue-400 hover:underline text-sm hover:text-blue-800 dark:hover:text-blue-300">
                                    View →
                                  </a>
                                )}
                              </div>
                              {project.role && <p className="text-sm text-gray-700 dark:text-gray-300 mt-1">Role: {project.role}</p>}
                              ...
                              {project.technologies && project.technologies.length > 0 && (
                                <div className="flex flex-wrap gap-2 mt-3">
                                  {project.technologies.map((tech: string, techIndex: number) => (
                                    <span key={techIndex} className="px-2 py-1 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-200 border border-indigo-200 dark:border-indigo-500/20 rounded text-xs">
                                      {tech}
                                    </span>
                                  ))}
                                </div>
                    ...
                    {candidate.publications && candidate.publications.length > 0 && (
                      <Card className="glass-card border-0 shadow-lg">
                        <CardHeader className="bg-gradient-to-r from-rose-50 to-pink-50 dark:from-rose-950/40 dark:to-pink-950/40 rounded-t-lg border-b border-rose-100 dark:border-white/5">
                        ...
                        <CardContent className="pt-6 space-y-4">
                          {candidate.publications.map((pub: any, index: number) => (
                            <div key={index} className="border-l-4 border-rose-500/50 pl-4 py-2 hover:bg-rose-50 dark:hover:bg-white/5 transition-colors rounded-r-lg">
                              <h4 className="font-semibold text-rose-900 dark:text-rose-100">{pub.title}</h4>
                              {pub.publication && <p className="text-sm text-gray-700 dark:text-gray-300 italic">{pub.publication}</p>}
                              {pub.authors && pub.authors.length > 0 && (
                                <p className="text-sm text-gray-600 dark:text-gray-400">Authors: {pub.authors.join(', ')}</p>
                              )}
                              {pub.publishDate && <p className="text-xs text-gray-500">{pub.publishDate}</p>}
                              {pub.description && <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">{pub.description}</p>}
                              {pub.url && (
                                <a href={pub.url} target="_blank" rel="noopener noreferrer"
                                  className="text-sm text-rose-600 dark:text-rose-400 hover:text-rose-800 dark:hover:text-rose-300 hover:underline mt-2 inline-block">
                                  Read Publication →
                                </a>
                              )}
                            </div>
                    ...
                    {candidate.volunteerWork && candidate.volunteerWork.length > 0 && (
                      <Card className="glass-card border-0 shadow-lg">
                        <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/40 dark:to-emerald-950/40 rounded-t-lg border-b border-green-100 dark:border-white/5">
                        ...
                        <CardContent className="pt-6 space-y-4">
                          {candidate.volunteerWork.map((vol: any, index: number) => (
                            <div key={index} className="border border-green-200 dark:border-green-500/20 rounded-lg p-4 bg-green-50 dark:bg-green-900/10 hover:bg-green-100 dark:hover:bg-green-900/20 transition-colors">
                              <h4 className="font-semibold text-green-900 dark:text-green-100">{vol.role || 'Volunteer'}</h4>
                              {vol.organization && <p className="text-gray-700 dark:text-gray-300">{vol.organization}</p>}
                              {(vol.startDate || vol.endDate) && (
                                <p className="text-sm text-gray-500 dark:text-gray-400">{vol.startDate} - {vol.endDate || 'Present'}</p>
                              )}
                              {vol.description && <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">{vol.description}</p>}
                              {vol.impact && (
                                <p className="text-sm text-green-700 dark:text-green-400 mt-2 font-medium">Impact: {vol.impact}</p>
                              )}
                            </div>
                          ))}
                        </CardContent>
                    ...
                    {candidate.professionalMemberships && candidate.professionalMemberships.length > 0 && (
                      <Card className="glass-card border-0 shadow-lg">
                        <CardHeader className="bg-gradient-to-r from-slate-100 to-gray-100 dark:from-slate-900/40 dark:to-gray-900/40 rounded-t-lg border-b border-gray-200 dark:border-white/5">
                        ...
                        <CardContent className="pt-6">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {candidate.professionalMemberships.map((mem: any, index: number) => (
                              <div key={index} className="flex items-start gap-2 p-3 border border-gray-200 dark:border-white/10 rounded-lg bg-white dark:bg-white/5 hover:bg-gray-50 dark:hover:bg-white/10 transition-colors">
                                <Users className="h-4 w-4 text-slate-500 dark:text-slate-400 mt-1" />
                                <div>
                                  <h4 className="font-medium text-slate-900 dark:text-slate-200">{mem.organization}</h4>
                                  {mem.role && <p className="text-sm text-gray-600 dark:text-gray-400">{mem.role}</p>}
                                  {mem.description && <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">{mem.description}</p>}
                                </div>
                              </div>
                            ))}
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {candidate.portfolioLinks.github && (
                              <a href={candidate.portfolioLinks.github} target="_blank" rel="noopener noreferrer"
                                className="flex items-center gap-2 p-3 border border-gray-200 dark:border-white/10 rounded-lg hover:bg-gray-50 dark:hover:bg-white/10 transition-colors bg-white dark:bg-white/5">
                            ...
                            {candidate.portfolioLinks.linkedin && (
                              <a href={candidate.portfolioLinks.linkedin} target="_blank" rel="noopener noreferrer"
                                className="flex items-center gap-2 p-3 border border-blue-200 dark:border-white/10 rounded-lg hover:bg-blue-50 dark:hover:bg-white/10 transition-colors bg-white dark:bg-white/5">
                            ...
                            {candidate.portfolioLinks.personalWebsite && (
                              <a href={candidate.portfolioLinks.personalWebsite} target="_blank" rel="noopener noreferrer"
                                className="flex items-center gap-2 p-3 border border-green-200 dark:border-white/10 rounded-lg hover:bg-green-50 dark:hover:bg-white/10 transition-colors bg-white dark:bg-white/5">
                                <Globe className="h-5 w-5 text-green-600 dark:text-green-400" />
                                <span className="text-sm text-gray-700 dark:text-gray-300">Personal Website</span>
                              </a>
                            )}
                            {candidate.portfolioLinks.portfolio && (
                              <a href={candidate.portfolioLinks.portfolio} target="_blank" rel="noopener noreferrer"
                                className="flex items-center gap-2 p-3 border border-purple-200 dark:border-white/10 rounded-lg hover:bg-purple-50 dark:hover:bg-white/10 transition-colors bg-white dark:bg-white/5">
                                <Briefcase className="h-5 w-5 text-purple-600 dark:text-purple-400" />
                            ...
                            {candidate.portfolioLinks.stackoverflow && (
                              <a href={candidate.portfolioLinks.stackoverflow} target="_blank" rel="noopener noreferrer"
                                className="flex items-center gap-2 p-3 border border-orange-200 dark:border-white/10 rounded-lg hover:bg-orange-50 dark:hover:bg-white/10 transition-colors bg-white dark:bg-white/5">
                                <Code className="h-5 w-5 text-orange-600 dark:text-orange-400" />
                                <span className="text-sm text-gray-700 dark:text-gray-300">Stack Overflow</span>
                              </a>
                            )}
                            {candidate.portfolioLinks.medium && (
                              <a href={candidate.portfolioLinks.medium} target="_blank" rel="noopener noreferrer"
                                ...
                                <span className="text-sm text-gray-700 dark:text-gray-300">Blog/Medium</span>
                              </a>
                            )}
                          </div>
                        </CardContent>
                    ...
                    {candidate.additionalSections && Object.keys(candidate.additionalSections).length > 0 && (
                      <Card className="glass-card border-0 shadow-lg">
                        <CardHeader className="bg-gradient-to-r from-violet-950/40 to-purple-950/40 rounded-t-lg border-b border-white/5">
                        ...
                        <CardContent className="pt-6 space-y-4">
                          {Object.entries(candidate.additionalSections).map(([sectionName, sectionContent]: [string, any], index: number) => (
                            <div key={index} className="border-l-4 border-violet-500/50 pl-4 py-2 hover:bg-white/5 transition-colors rounded-r-lg">
                              <h4 className="font-semibold text-violet-100 mb-2">{sectionName}</h4>
                              <p className="text-sm text-gray-300 whitespace-pre-wrap">{sectionContent}</p>
                            </div>
                          ))}
                        </CardContent>
                      </Card>
