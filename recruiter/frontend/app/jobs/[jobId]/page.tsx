...
import { InternalRecruitmentDialog } from "@/components/jobs/internal-recruitment-dialog"
...
function JobDetailInnerPage() {
  ...
  const fetchJobData = async () => {
    try {
      setLoading(true)
      const data = await getJobById(params.jobId as string)
  ...
  return (
    <div className={cn(
      ...
      {/* Internal Recruitment Dialog */}
      <InternalRecruitmentDialog
        open={showInternalDialog}
        onOpenChange={setShowInternalDialog}
        mode={internalDialogMode}
        jobId={params.jobId as string}
        jobTitle={jobData?.title || ''}
        currentLimit={jobData?.internalCandidateApplyLimit}
        currentApplicationCount={jobData?.internalApplicationCount}
        reservedCredits={jobData?.reservedInternalCredits}
        creditInfo={creditInfo}
