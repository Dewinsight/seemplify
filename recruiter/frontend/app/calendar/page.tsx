          ...
          <div className="flex gap-2">
            {interview.conferencing?.details?.url && (
              <Button size="sm" variant="outline" asChild>
                <a href={interview.conferencing.details.url} target="_blank" rel="noopener noreferrer">
            ...
            {interview.notetakerEnabled && (
              <Button 
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  router.push(`/interviews/${interview._id}/transcript?from=calendar`);
                }}
                title={interview.status === 'completed' && interview.transcript ? "View Completed Transcript" : "View Live Transcript"}
              >
                <FileText className="h-4 w-4 mr-1" />
                {interview.status === 'completed' && interview.transcript ? "View Transcript" : "Transcript"}
              </Button>
            )}
            ...
            <Button size="sm" variant="ghost" onClick={() => onViewDetails(interview)}>
