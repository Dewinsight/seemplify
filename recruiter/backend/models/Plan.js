...
const PlanSchema = new mongoose.Schema({
  ...
  credits: {
    ...
    creditCosts: {
      ...
      uploadCandidate: { type: Number, default: 9, min: 0 },
      scheduleInterview: { type: Number, default: 2, min: 0 },
      aiMatching: { type: Number, default: 16, min: 0 },
      generateQuestions: { type: Number, default: 9, min: 0 },
      aiAnalysis: { type: Number, default: 17, min: 0 },
      bulkUpload: { type: Number, default: 6, min: 0 },
