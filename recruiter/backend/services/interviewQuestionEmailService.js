    ...
    try {
      ...
      for (const interview of interviews) {
        try {
          ...
          if (now >= sendTime) {
            await this.sendQuestionEmail(interview);
            
            // Update that we've sent the email
    ...
    try {
      ...
      for (const participant of participants) {
        const htmlContent = `
          ...
          <body>
            <div class="container">
              ...
              <div class="footer">
                <p>This email was automatically generated by SmartHR. Please do not reply.</p>
              </div>
            </div>
          </body>
          </html>
        ...
        await emailService.sendUserNotification(
          participant.email,
          `Interview Feedback Access for ${candidate.firstName} ${candidate.lastName} - ${interviewDate}`,
