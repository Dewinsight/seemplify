      ...
      <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl items-center gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(420px,1fr)]">
        <section className="hidden lg:block">
          <div className="max-w-xl">
            <div className="mb-5 inline-flex rounded-md border border-blue-200 bg-blue-50 px-3 py-1 text-sm font-medium text-blue-700">
              Seemplify Candidate Portal
            </div>
            <h1 className="text-5xl font-semibold tracking-tight text-slate-950">Review, sign, and keep your onboarding documents.</h1>
        ...
        <section className="rounded-md border border-slate-200 bg-white p-6 shadow-soft sm:p-8">
          <div className="mb-8">
            <div className="text-sm font-semibold uppercase tracking-wide text-blue-700">Candidate login</div>
          ...
          <form className="space-y-4" onSubmit={submit}>
            <label className="block">
              ...
              <div className="relative">
                ...
                <input
                  className="h-11 w-full rounded-md border border-slate-300 bg-white pl-10 pr-3 text-slate-950 outline-none ring-blue-500 transition focus:ring-2"
                  type="email"
                  value={email}
          ...
          <p className="mt-6 text-sm text-slate-600">
            ...
            <Link className="font-medium text-blue-700 hover:underline" href="/signup">candidate signup</Link>.
          </p>
        </section>
      </div>
    </main>
