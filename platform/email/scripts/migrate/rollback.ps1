...
param(
 ...
 [Parameter(Mandatory)][string]$Confirmation,[switch]$Execute
)
...
$script="set -eu; cd '$RemoteComposeDirectory'; docker compose stop cloudflared mail-api postal-worker; /opt/seemplify-mail-migration/bin/queue-inspect.sh --project seemplify-mail-prod --require-empty"
