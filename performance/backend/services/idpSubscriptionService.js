 ...
 * Used to check if an organization has access to Performance Management
 */

const IDP_URL = process.env.IDP_URL || process.env.OIDC_ISSUER || 'http://localhost:4000'
const FEATURE_KEY = 'performanceManagement'
 ...
 * @param {string} featureKey - Feature to check (defaults to performanceManagement)
 ...
 *
 * @param {string} appName - Name of the app (e.g., 'performance-management')
