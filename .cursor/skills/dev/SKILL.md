---
name: dev
description: Bridges to the BMAD Developer agent. Loads _bmad/bmm/agents/dev.md and follows its activation and workflows. Use when implementing stories, running dev-story or code-review, or when development expertise is needed.
---

# Developer (BMAD bridge)

This skill **does not replicate** the Dev agent. It **delegates to BMAD**.

## 1. Load the BMAD agent

- Read **`_bmad/bmm/agents/dev.md`** in full.
...
- Persona, principles, menu items, and handlers stay in **`_bmad/bmm/agents/dev.md`**. This skill only points at BMAD and ensures the correct config and workflow/exec mechanics are used.
