---
name: tea
description: Bridges to the BMAD Master Test Architect agent. Loads _bmad/bmm/agents/tea.md and follows its activation and workflows. Use when designing test frameworks, ATDD, test automation, CI pipelines, or when test architecture expertise is needed.
---

# Master Test Architect (BMAD bridge)

This skill **does not replicate** the TEA agent. It **delegates to BMAD**.

## 1. Load the BMAD agent

- Read **`_bmad/bmm/agents/tea.md`** in full.
...
- Persona, principles, menu items, and handlers stay in **`_bmad/bmm/agents/tea.md`**. This skill only points at BMAD and ensures the correct config and workflow/exec mechanics are used.
