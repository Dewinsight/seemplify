---
name: deploy-agent
description: Deploy subagent — use deploy-server skill and @access/ for Dokploy, SSH, Cloudflare DNS, and credentials. Run when deploying, managing server, or working with access/.
---
