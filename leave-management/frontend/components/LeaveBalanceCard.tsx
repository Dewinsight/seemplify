...
export default function LeaveBalanceCard({ balance }: LeaveBalanceCardProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-zinc-900/90 to-zinc-800/90 backdrop-blur-xl rounded-xl shadow-lg border border-zinc-700/50 p-6 relative overflow-hidden hover:border-purple-500/50 hover:shadow-purple-500/10 transition-all duration-300">
      ...
      <div className="relative">
        <div className="flex items-center justify-between mb-5">
          <h3 className="text-lg font-bold text-zinc-100">Leave Balance</h3>
          <Badge variant="outline" className="bg-zinc-800/60 border-zinc-700 text-zinc-300">This year</Badge>
        </div>
            ...
            <div key={type}>
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-sm text-zinc-400">
                  <span className="font-semibold text-zinc-200">{available}</span>
                  <span className="text-zinc-500"> / {typeBalance.total} days</span>
                </span>
              </div>
              <div className="w-full bg-zinc-800/70 rounded-full h-2.5 overflow-hidden relative">
                <div
...
export function BalanceSummary({ summary }: BalanceSummaryProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="bg-gradient-to-br from-zinc-900/90 to-zinc-800/90 rounded-xl p-5 border border-green-500/20 hover:border-green-500/40 transition-all duration-300 shadow-lg hover:shadow-green-500/10 relative overflow-hidden group">
      ...
      <div className="bg-gradient-to-br from-zinc-900/90 to-zinc-800/90 rounded-xl p-5 border border-indigo-500/20 hover:border-indigo-500/40 transition-all duration-300 shadow-lg hover:shadow-indigo-500/10 relative overflow-hidden group">
      ...
      <div className="bg-gradient-to-br from-zinc-900/90 to-zinc-800/90 rounded-xl p-5 border border-amber-500/20 hover:border-amber-500/40 transition-all duration-300 shadow-lg hover:shadow-amber-500/10 relative overflow-hidden group">
