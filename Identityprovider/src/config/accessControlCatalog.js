...
export const PRODUCT_PERMISSION_CATALOG = Object.freeze([
  ...
  product('messaging', 'Workspace', [
    ...
    permission('boards.read', 'View boards, sprints, and work items', 'organization',
      'Open boards and read their work items, backlog, sprints, and releases.'),
    permission('boards.create', 'Create boards', 'organization',
      'Create new boards for the organization.'),
    permission('boards.edit', 'Edit boards and work items', 'organization',
      'Create and update work items, move them across statuses, and plan them into an existing sprint.'),
    permission('boards.delete', 'Delete boards and work items', 'organization',
      'Delete boards and remove work items.'),
    permission('boards.manage', 'Manage boards and sprints', 'organization',
      'Create, edit, start, complete, and delete sprints; manage releases, components, saved views, '
      + 'board features, notifications, and archiving. Owners and admins hold this by default; employees do not.'),
