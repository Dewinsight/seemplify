...
export const PAYROLL_BANK_JURISDICTIONS = [
  ...
  },
  {
    ...
    accountNumberLabel: 'Account Number',
    accountNumberPlaceholder: 'Bank account number',
    accountNumberHint: 'Use the account number shown on your Canadian direct-deposit details.',
    requiresAccountNumber: true,
    localField: {
      key: 'bankCode',
    ...
    supportsSwift: true,
    swiftRequired: false,
    swiftHint: 'Add SWIFT/BIC only when an international wire is required.',
    bankDirectory: null,
    accountTypes: CURRENT_AND_SAVINGS_ACCOUNT_TYPES,
  },
  {
    ...
    currency: 'XAF',
    label: 'Cameroon',
    description: 'Use the domestic account or RIB details supplied by your bank.',
    accountNumberLabel: 'Account / RIB Number',
    accountNumberPlaceholder: 'Domestic account or RIB number',
    accountNumberHint: 'Enter the account identifier exactly as provided by your bank.',
    requiresAccountNumber: true,
    localField: {
      key: 'bankCode',
      label: 'Bank / Branch Code',
      placeholder: 'Bank or branch code',
      hint: 'Use the domestic bank or branch code shown on your account details.',
      required: true,
    },
    supportsIban: true,
    requiresIban: false,
  ...
  },
  {
    ...
    currency: 'MZN',
    label: 'Mozambique',
    description: 'Use the account or NIB details issued by your Mozambican bank.',
    accountNumberLabel: 'Account / NIB Number',
    accountNumberPlaceholder: 'Account or NIB number',
    accountNumberHint: 'Enter the domestic account or NIB identifier exactly as issued by your bank.',
    requiresAccountNumber: true,
    localField: null,
    supportsIban: false,
    requiresIban: false,
