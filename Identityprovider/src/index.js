...
app.get('/', async (req, res) => {
  try {
    ...
    res.render('home', {
      ...
      pendingSignatureCount: recruiterTransitionSummary?.pendingSignatureCount || 0,
      pendingSignatureDocuments: notificationSummary.pendingSignatureDocuments || [],
      firstDocumentNotificationActionUrl: recruiterTransitionSummary?.deepLink || '/documents',
