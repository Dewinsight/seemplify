...
| Roles, plans, quotas, retention, flags, audit, observability and runbooks | `X-01` and `X-03` already prove managed plan catalogues, usage-ledger foundations, and progressive rollout/kill-switch controls; `X-02` now also has stronger route-level HTTP proof for several sensitive Journey surfaces, including suggestions, metric alerts, and identity-governance entry points. | In progress but materially incomplete: governance primitives and some route-level enforcement are proven, but the release-grade proof chain is still broken across multiple cross-cutting requirements. | Completion proof for the remaining `X-02` matrix plus `X-05`, `X-08`, `X-09`, and `X-10`: full route-by-route capability enforcement, privacy/DPIA/retention controls, ratified telemetry/SLO/runbooks, signed rollout gates, and published verified documentation. |
