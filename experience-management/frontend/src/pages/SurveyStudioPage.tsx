...
export function SurveyStudioPage() {
  ...
  return <div className="space-y-5">
    ...
    <Tabs defaultValue="build"><TabsList className="w-full justify-start overflow-x-auto"><TabsTrigger value="build">Build</TabsTrigger><TabsTrigger value="collect">Distribute</TabsTrigger><TabsTrigger value="responses">Responses</TabsTrigger><TabsTrigger value="analytics">Analytics</TabsTrigger><TabsTrigger value="ai">Terra AI</TabsTrigger><TabsTrigger value="settings">Settings</TabsTrigger></TabsList><TabsContent value="build"><BuilderTab survey={draft} onChange={change} /></TabsContent><TabsContent value="collect"><CollectTab survey={draft} collectors={data.collectors} onRefresh={load} /></TabsContent><TabsContent value="responses"><ResponsesTab survey={draft} refreshKey={refreshKey} /></TabsContent><TabsContent value="analytics"><AnalyticsTab survey={draft} refreshKey={refreshKey} /></TabsContent><TabsContent value="ai"><AiTab survey={draft} onApplyImprovement={applyImprovement} refreshKey={refreshKey} /></TabsContent><TabsContent value="settings"><SettingsTab survey={draft} onChange={change} /></TabsContent></Tabs>
  </div>;
}
