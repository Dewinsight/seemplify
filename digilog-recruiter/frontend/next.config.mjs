        ...
        headers: [
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://api.nylas.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https: http: blob:; connect-src 'self' https://api.nylas.com https://api.brevo.com https://172-182-227-84.nip.io https://172-182-227-84.nip.io https://auth.seemplifyai.com https://auth-dev.seemplifyai.com https://*.seemplifyai.com https://*.aiinnigeria.com https://*.radiantdigilog.com https://radiantdigilog.com wss://*.radiantdigilog.com wss: ws: http://localhost:* https://thesmarthr.netlify.app https://*.azurewebsites.net wss://*.azurewebsites.net; media-src 'self' blob:; object-src 'none'; frame-src 'self' blob: https://api.nylas.com; worker-src 'self' blob:; child-src 'self' blob:; form-action 'self'; upgrade-insecure-requests"
          },
          {
