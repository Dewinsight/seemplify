...
export const CANDIDATE_BRANDS: Record<CandidateBrandId, CandidateBrand> = {
  seemplify: {
    ...
    accentTextClass: "text-[#6935CF]",
    accentBgClass: "bg-[#F1ECFF]",
    accentBorderClass: "border-[#D9CCF8]",
    focusRingClass: "ring-[#754BE5]",
    primaryButtonClass: "bg-[#754BE5] hover:bg-[#6935CF]",
    softGradientClass: "from-[#F1ECFF] via-white to-[#FAF9FE]",
    sidebarClass: "border-[#E7E2F7] bg-white/92",
    navActiveClass: "bg-[#754BE5] text-white",
    progressClass: "bg-[#754BE5]",
  },
  "akwa-ibom": {
    id: "akwa-ibom",
